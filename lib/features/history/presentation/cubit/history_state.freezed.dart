...
mixin _$HistoryState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<History> history) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<History> history)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<History> history})
    : _history = history;
...
abstract class _Loaded implements HistoryState {
  const factory _Loaded({required final List<History> history}) = _$LoadedImpl;
